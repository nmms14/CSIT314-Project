...
<div class="report-header">
    <div>
        <h1>Weekly Report</h1>
        <p style="margin:6px 0 0;color:#374151;">For <?= htmlspecialchars(date('d M Y', strtotime($meta['week_start']))) ?> &mdash; <?= htmlspecialchars(date('d M Y', strtotime($meta['week_end']))) ?></p>
    </div>
        ...
        <table>
            ...
            <tbody>
                <?php if (empty($activities)): ?>
                    <tr class="empty-row"><td colspan="3">No activities created in this week</td></tr>
    ...
    <table>
        ...
        <tbody>
            <?php if (empty($favourites)): ?>
                <tr class="empty-row"><td colspan="4">No favourites added in this week</td></tr>
...
<div class="report-actions">
    <a href="weekly_report.php" class="btn">Generate another report</a>
</div>
