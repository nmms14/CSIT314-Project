...
<div class="report-header">
    <div>
        ...
        <p style="margin:6px 0 0;color:#374151;">For <?= htmlspecialchars(date('F Y', strtotime($meta['month_start']))) ?></p>
    </div>
        ...
        <table>
            ...
            <tbody>
                <?php if (empty($activities)): ?>
                    <tr class="empty-row"><td colspan="3">No activities created in this month</td></tr>
    ...
    <table>
        ...
        <tbody>
            <?php if (empty($favourites)): ?>
                <tr class="empty-row"><td colspan="4">No favourites added in this month</td></tr>
...
<div class="report-actions">
    <a href="monthly_report.php" class="btn">Generate another report</a>
</div>
